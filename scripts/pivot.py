...
def main():
    ...
    parser.add_argument('--min', help="pivot 5min data", dest='do_5min', action='store_true')
    parser.add_argument('--no-5min', help="don't pivot 5min data", dest='do_5min', action='store_false')
    parser.add_argument('--daily', help="pivot daily data", dest='do_daily', action='store_true')
    parser.add_argument('--no-daily', help="don't pivot daily data", dest='do_daily', action='store_false')
