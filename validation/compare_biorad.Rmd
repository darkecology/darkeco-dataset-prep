...
KBGM = stations[stations$callsign == "KBGM", ]
...
vpi_cajun <- read_csv("../data/scans/2019/KBGM-2019.csv")
...
mape <- function(a, b) {
  return (100*mean(abs(a-b)/a))
}

# Show MAPE
print(mape(vpi$vir, vpi_cajun$reflectivity))
print(mape(vpi$rtr, vpi_cajun$traffic_rate))
print(mape(vpi$ff, vpi_cajun$speed))
print(mape(vpi$dd, vpi_cajun$direction))
print(mape(vpi$u, vpi_cajun$u))
print(mape(vpi$v, vpi_cajun$v))
